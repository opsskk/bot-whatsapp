...
/////////////////
const BotName = 'FBI BOT☄'; 
const instagram = 'https://instagram.com/reuz.id'; 
const telegram = 'https://t.me/us_projeck; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Diyon afan')
